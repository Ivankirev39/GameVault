          ...
          <div class="p-8 space-y-4 md:space-y-6 sm:p-4">
              ...
              <div class="p-2 space-y-2 md:space-y-2  flex flex-col items-center">
                  ...
                  >
                      ...
                      <input type="password" class=" md:text-lg rounded-lg block w-[450px] p-3 bg-gray-700 border-gray-600 placeholder-gray-400 text-[#f4f4f4] focus:ring-purple-500 focus:border-purple-500" v-model="password" placeholder="Password" required>
                  ...
                  >
                      <input type="email" class="md:text-lg rounded-lg block w-[450px] p-3 bg-gray-700 border-gray-600 placeholder-gray-400 text-[#f4f4f4] focus:ring-purple-500 focus:border-purple-500" v-model="registerEmail" placeholder="Email" required>
                      <input type="password" class="md:text-lg rounded-lg block w-[450px] p-3 bg-gray-700 border-gray-600 placeholder-gray-400 text-[#f4f4f4] focus:ring-purple-500 focus:border-purple-500" v-model="registerPassword" placeholder="Password" required>
                      <span class="text-[#f4f4f4] text-lg w-[450px] text-left">Make sure to write a strong password! </span>
                      <button type="submit" class="w-[450px] bg-transparent border-2 border-[#A80ADD] text-[#A80ADD] hover:bg-[#A80ADD] hover:text-[#f4f4f4] font-bold py-3 px-6 rounded-lg transition-colors text-xl" :disabled="loading"> Register </button>
                  </form>
                  ...
                  <button
                            v-if="isLoggedIn"
                            @click="logoutUser"
                            class="w-[450px] bg-transparent border-2 border-[#A80ADD] text-[#A80ADD] hover:bg-[#A80ADD] hover:text-[#f4f4f4] font-bold py-3 px-6 rounded-lg transition-colors text-xl mt-4"
                        >
                            Logout
                        </button>
